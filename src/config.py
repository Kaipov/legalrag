...
ENABLE_VISION_OCR_FALLBACK = _get("ENABLE_VISION_OCR_FALLBACK", "1").lower() in {"1", "true", "yes", "on"}
VISION_OCR_MODEL = _get("VISION_OCR_MODEL", GENERATION_MODEL)
VISION_OCR_MAX_OUTPUT_TOKENS = max(256, _get_int("VISION_OCR_MAX_OUTPUT_TOKENS", 1500))
